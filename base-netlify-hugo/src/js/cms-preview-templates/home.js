...
export default class PostPreview extends React.Component {
  render() {
    ...
    return <div>
        ...
        <div className=" ">
          <div className=" ">
            <h2 className=" ">{entry.getIn(["data", "blurb", "heading"])}</h2>
            <p className=" ">{entry.getIn(["data", "blurb", "text"])}</p>
          </div>
        </div>

        <div className=" ">
          <div className=" ">
            <h2 className=" ">{entry.getIn(["data", "intro", "heading"])}</h2>
        ...
        <div className=" ">
          <div className=" ">
            ...
            <div className=" ">
              <div className=" ">
                <h2 className=" ">{entry.getIn(["data", "values", "heading"])}</h2>
