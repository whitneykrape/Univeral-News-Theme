...
/*
if ( ! function_exists( 'slim_admin_styles' ) ) :
	function slim_admin_styles() {
    	wp_enqueue_style( 'admin_css', get_template_directory_uri() . '/assets/css/style.css', false, '1.0.0' );
    }
endif;
add_action( 'admin_enqueue_scripts', 'slim_admin_styles' );
*/
