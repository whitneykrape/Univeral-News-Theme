...
if(void 0!==t.sampled)return t.setMetadata({transactionSampling:{method:"explicitly_set",rate:Number(t.sampled)}}),t
let i
...
var b=n(7209)
class x{constructor(){x.prototype.__init.call(this)}static __initStatic(){this.id="Apollo"}__init(){this.name=x.id}setupOnce(t,e){var n=(0,m.$y)("apollo-server-core")
...
var l=t.call(this,...d)
return(0,_.J8)(l)?l.then((t=>((0,s.x)([o,"optionalAccess",t=>t.finish,"call",t=>t()]),t))):((0,s.x)([o,"optionalAccess",t=>t.finish,"call",t=>t()]),l)}}))}(t,n,i,e)}))})),t))),t.call(this)}})):r.kg.error("Apollo Integration was unable to require apollo-server-core package.")}}x.__initStatic()
var D=n(75492),N=n(22850),k=n(66627),B=n(68256),G=n(27448),Y=n(48206),U=(0,k.R)(),A=n(4549),I=n(88468),C=(t,e,n)=>{let i
...
return n.observe({type:t,buffered:!0}),n}}catch(t){}},$=(t,e)=>{var n=i=>{"pagehide"!==i.type&&"hidden"!==(0,k.R)().document.visibilityState||(t(i),e&&(removeEventListener("visibilitychange",n,!0),removeEventListener("pagehide",n,!0)))}
addEventListener("visibilitychange",n,!0),addEventListener("pagehide",n,!0)}
let M=-1
var L=()=>(M<0&&(M="hidden"===(0,k.R)().document.visibilityState?0:1/0,$((t=>{let{timeStamp:e}=t
...
return n&&t.startTimestamp>n&&(t.startTimestamp=n),t.startChild({startTimestamp:n,...i})}var z=(0,k.R)()
...
t.args[1]=t.args[1]||{}
var o=t.args[1]
o.headers=function(t,e,n,i){var a=(0,N.IQ)(e),s=n.toTraceparent(),r="undefined"!=typeof Request&&(0,_.V9)(t,Request)?t.headers:i.headers
...
c&&t.xhr.setRequestHeader(N.bU,c),s.metadata.propagations+=1}catch(t){}}}}}(t,o,c)}))}var at=(0,k.R)(),st="BrowserTracing",rt={idleTimeout:G.nT,finalTimeout:G.mg,markBackgroundTransactions:!0,routingInstrumentation:function(t){let e=!(arguments.length>1&&void 0!==arguments[1])||arguments[1],n=!(arguments.length>2&&void 0!==arguments[2])||arguments[2]
...
var o=s+i
H(t,{description:n,endTimestamp:o+a,op:e.initiatorType?`resource.${e.initiatorType}`:"resource",startTimestamp:o,data:r})}}(t,e,d,i,o,n)}})),J=Math.max(i.length-1,0),function(t){var e=z.navigator
...
var r=(this.metadata.transactionSampling||{}).rate,c=void 0!==r?r.toString():void 0,_=t.getScope()
...
//# sourceMappingURL=chunk.174.e1e89637eab79fdd5c5d.map